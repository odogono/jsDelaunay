...
var Edge = function(){
    ...
    this.b = 0;
    this.c = 0;
    this.leftVertex = null; //Vertex.create();
    this.rightVertex = null; //Vertex.create();
...
Edge.prototype.isPartOfConvexHull = function() {
    return (this.leftVertex === null || this.rightVertex === null);
}
        
Edge.prototype.sitesDistance = function() {
    return Vertex.distance( this.sites[LR.LEFT], this.sites[LR.RIGHT] );
}

Edge.prototype.delaunayLine = function()/*:LineSegment*/ {
    // draw a line connecting the input Sites for which the edge is a bisector:
    return LineSegment.create(this.leftSite, this.rightSite);
}

Edge.prototype.voronoiEdge = function()/*:LineSegment*/ {
    if (!visible){ 
        return LineSegment.create();
    }
    return LineSegment.create(this.clippedVertices[LR.LEFT], this.clippedVertices[LR.RIGHT]);
}
...
var compareSitesDistances_MAX = function(edge0/*:Edge*/, edge1/*:Edge*/) {
...
EdgeList.prototype.edgeListLeftNeighbor = function(p /*Point*/){
    ...
    bucket = Math.round( (p[0] - this.xmin)/this.deltaX * this.hashSize );
